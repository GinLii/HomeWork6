...
public class TodoListAdapter extends RecyclerView.Adapter<TodoListItemHolder> {
    ...
    public TodoListItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new TodoListItemHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.todo_item_layout, parent, false),mOnRecordClickListener);
    }
    ...
    public interface OnRecordClickListener {
        void onButtonClick(View view, long ID);
        void onCheck(View view, long ID, boolean isChecked);
    }
